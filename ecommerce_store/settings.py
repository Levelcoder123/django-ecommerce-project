...
from ecommerce_store.env_utils import get_env_variable
...
# Using postgresql for a professional project
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'ecommerce_db',  # Your PostgreSQL database name
        'USER': 'estore_user',  # Your PostgreSQL username
        'PASSWORD': 'estore_pass_0034',  # Your PostgreSQL password
...
# login url name for @login_required
